...
## "The Oil Drilling Major Update" について
（**2023/3/18更新**）

現在、個人的な事情により、普段作業を行うメインPCにアクセスすることが出来ず、代替のノートPC（MacOS）で今回のアップデートの翻訳作業を行いました。しかし、このノートPCではStormworksを起動できるだけのマシンパワーがなく、実際の翻訳の確認が不可能な状態です。おまけに、[Steamワークショップ上の翻訳データ](https://steamcommunity.com/sharedfiles/filedetails/?id=2081775581)も更新できません。4月上旬頃にメインPCへの復帰を予定しています。それまでしばらくお待ちください。

尚、今直ぐ翻訳データが欲しい方は、こちらのレポジトリから直接入手して、手動でゲームに適用してください。適用方法は[下記](#日本語化の方法)をご覧ください。但し、翻訳が根本的におかしい可能性がありますのでご了承ください。
